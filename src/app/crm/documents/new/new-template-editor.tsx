...
import { createDocumentTemplate } from "@/app/lib/documentsApi";
...
interface FormElement {
  ...
  userId?: string | null; // Optional user ID for tracking ownership
}
...
export function DocumentEditor() {
  ...
  const handleSave = async () => {
    ...
    try {
      // Convert form elements to backend format
      ...
      // Simulate API call
      const res = await createDocumentTemplate(templateData, token);
      console.log("Template saved response:", res);
  ...
  const renderFormElement = (
    ...
    const elementContent = () => {
      switch (element.type) {
        case "headline":
          const HeadingTag = (element.properties?.size ||
            "h2") as React.ElementType;
              ...
              <div className="w-80 border-l bg-card">
                <div className="p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    {(selectedElementData.type === "short_answer" ||
                      selectedElementData.type === "long_answer" ||
                      selectedElementData.type === "number_input") && (
                      <div>
                    ...
                    {selectedElementData.type === "dropdown" && (
                      <div>
        ...
        <Dialog open={showSaveDialog} onOpenChange={setShowSaveDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                You have unsaved changes. Would you like to save your template
                before leaving?
              </DialogDescription>
            </DialogHeader>
